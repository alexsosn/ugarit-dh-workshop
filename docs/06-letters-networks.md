# 6. Letters as a social source

*Hour 3 · ~5 min reading + leads into notebook `3b` (~10 min)*
...
places, and institutions they form.
...
> **Transition:** notebook `3b_letter_networks` builds and visualizes the graph
> from the letters (and overlapping names in administrative texts).

## TODO
- [ ] Note which sample texts contribute nodes/edges (2.10, 2.11, 2.13, 4.102, 4.103).
- [ ] Add an example network figure once generated.
